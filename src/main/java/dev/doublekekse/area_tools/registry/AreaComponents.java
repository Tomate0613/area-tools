...
public final class AreaComponents {
    ...
    public static final AreaDataComponentType<EnvironmentAttributesComponent> ENVIRONMENT_ATTRIBUTES_COMPONENT = registerTracking(EnvironmentAttributesComponent::new, "environment_attributes");
